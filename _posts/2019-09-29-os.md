...
categories: [Operating Systems, Desktop, Mobile]
tags: [Linux, Windows, MacOS, iOS, Android]
author: thinkprivacy
---

If you have a choice in your OS, we strongly recommended ditching MacOS or Windows and moving to a Linux driven system. Yet, even with Linux you have choices to make. Not sure which Linux distribution is right you? Check out [Try Linux](https://trylinux.danarel.com){:target="_blank"} to learn more about them.
